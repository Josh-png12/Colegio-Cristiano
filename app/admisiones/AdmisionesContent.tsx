    ...
    <>
            ...
            {pasos.map((paso, i) => (
              ...
              >
                ...
                <div className="bg-primary/5 w-14 h-14 rounded-xl flex items-center justify-center mb-5 group-hover:bg-primary/10 transition-colors">
                  <paso.icono className="w-7 h-7 text-primary" aria-hidden="true" />
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            <FadeIn direction="right">
              <div className="relative h-96 w-full rounded-3xl overflow-hidden shadow-xl">
                <Image
                  src={ADM_BENEFITS}
                  alt="Estudiantes del Colegio CCP"
                  fill
      ...
      <section className="py-24 bg-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
          <FadeIn>
            <Calendar className="w-12 h-12 text-secondary mx-auto mb-6" aria-hidden="true" />
          </FadeIn>
          <FadeIn delay={0.1}>
