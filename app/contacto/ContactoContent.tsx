...
const CONTACTO_HERO =
  "https://images.unsplash.com/photo-1427504494785-319ce8372ac0?q=80&w=1920&auto=format&fit=crop";
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-3 gap-12 max-w-6xl mx-auto">
            ...
            <div className="lg:col-span-1">
                ...
                {infoContacto.map((info, i) => (
                  ...
                  >
                    <div className="bg-primary/5 w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0">
                      <info.icono className="w-5 h-5 text-primary" aria-hidden="true" />
                    </div>
                    <div>
              ...
              {/* Map placeholder */}
              <div className="mt-10 bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 h-48 flex items-center justify-center" aria-label="Mapa de ubicación">
                ...
                <div className="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100">
                  ...
                  >
                    <div className="grid sm:grid-cols-2 gap-5">
                      <div>
                        <label htmlFor="ct-nombre" className="sr-only">Nombre completo</label>
                        <input
                          id="ct-nombre"
                          {...register("nombre")}
                      ...
                      <div>
                        <label htmlFor="ct-email" className="sr-only">Correo electrónico</label>
                        <input
                          id="ct-email"
                          {...register("email")}
                          type="email"
                    ...
                    <div>
                      <label htmlFor="ct-telefono" className="sr-only">Teléfono</label>
                      <input
                        id="ct-telefono"
                        {...register("telefono")}
                    ...
                    <div>
                      <label htmlFor="ct-mensaje" className="sr-only">Mensaje</label>
                      <textarea
                        id="ct-mensaje"
                        {...register("mensaje")}
                        rows={5}
